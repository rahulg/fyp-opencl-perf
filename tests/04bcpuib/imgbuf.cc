...
_X_TIMER_SETUP
	...
	try {
		...
		cl_uchar4 *host0 = static_cast<cl_uchar4*>(valloc(sizeof(cl_uchar4) * bufsz * 2));
		cl_uchar4 *host1 = static_cast<cl_uchar4*>(valloc(sizeof(cl_uchar4) * bufsz * 2));
		...
		cl_uchar *ihost0 = static_cast<cl_uchar*>(valloc(sizeof(cl_uchar) * bufsz * 2 * 4));
		cl_uchar *ihost1 = static_cast<cl_uchar*>(valloc(sizeof(cl_uchar) * bufsz * 2 * 4));
